	...
	specs := map[string]struct {
		...
		"with legacy params migrated": {
			...
			setup: func(ctx sdk.Context) {
				...
				// https://github.com/airchains-network/station-wasm/blob/v0.40.0/app/upgrades.go#L66
...
func storeCode(ctx sdk.Context, wasmApp *app.StationWasmApp, instantiatePermission types.AccessConfig) (codeID uint64, err error) {
