...
import (
	...
	nodeservice "github.com/airchains-network/cosmos-sdk/client/grpc/node"
	...
	runtimeservices "github.com/airchains-network/cosmos-sdk/runtime/services"
	"github.com/airchains-network/cosmos-sdk/server"
	"github.com/airchains-network/cosmos-sdk/server/api"
	...
	authcodec "github.com/airchains-network/cosmos-sdk/x/auth/codec"
	authkeeper "github.com/airchains-network/cosmos-sdk/x/auth/keeper"
	"github.com/airchains-network/cosmos-sdk/x/auth/posthandler"
	authsims "github.com/airchains-network/cosmos-sdk/x/auth/simulation"
	...
	authzkeeper "github.com/airchains-network/cosmos-sdk/x/authz/keeper"
	...
	consensusparamtypes "github.com/airchains-network/cosmos-sdk/x/consensus/types"
	"github.com/airchains-network/cosmos-sdk/x/crisis"
	crisiskeeper "github.com/airchains-network/cosmos-sdk/x/crisis/keeper"
	crisistypes "github.com/airchains-network/cosmos-sdk/x/crisis/types"
	distr "github.com/airchains-network/cosmos-sdk/x/distribution"
	distrkeeper "github.com/airchains-network/cosmos-sdk/x/distribution/keeper"
	...
	groupkeeper "github.com/airchains-network/cosmos-sdk/x/group/keeper"
	groupmodule "github.com/airchains-network/cosmos-sdk/x/group/module"
	"github.com/airchains-network/cosmos-sdk/x/mint"
	mintkeeper "github.com/airchains-network/cosmos-sdk/x/mint/keeper"
	minttypes "github.com/airchains-network/cosmos-sdk/x/mint/types"
	"github.com/airchains-network/cosmos-sdk/x/params"
	paramsclient "github.com/airchains-network/cosmos-sdk/x/params/client"
	...
	paramproposal "github.com/airchains-network/cosmos-sdk/x/params/types/proposal"
	"github.com/airchains-network/cosmos-sdk/x/slashing"
	slashingkeeper "github.com/airchains-network/cosmos-sdk/x/slashing/keeper"
...
func (app *WasmStationApp) FinalizeBlock(req *abci.RequestFinalizeBlock) (*abci.ResponseFinalizeBlock, error) {
	...
	app.once.Do(func() {
		...
		if _, err := app.ConsensusParamsKeeper.Params(ctx, &consensusparamtypes.QueryParamsRequest{}); err != nil {
			...
			// see https://github.com/airchains-network/cosmos-sdk/blob/v0.47.0/simapp/upgrades.go#L66
