...
func MakeEncodingConfig(t testing.TB) params.EncodingConfig {
	...
	tempApp := NewWasmStationApp(log.NewNopLogger(), dbm.NewMemDB(), nil, true, simtestutil.NewAppOptionsWithFlagHome(t.TempDir()), []wasmkeeper.Option{})
	return makeEncodingConfig(tempApp)
}

func makeEncodingConfig(tempApp *WasmStationApp) params.EncodingConfig {
